...
<div style="position: absolute; width: 764px; height: 243px; z-index: 1; left: 299px; top: -50px" id="layer5">
	...
	<div style="position: absolute; width: 796px; height: 40px; z-index: 1; left: 0px; top: 17px" id="layer9">
		<p align="center"><b>
		<font face="Bodoni MT Condensed" size="6" color="#D98A06">Notice Board</font></b></div>
        ...
        while(rs.next())
        {  
            notice=rs.getString(4);
            id=rs.getInt(5);
        %>
			<tr>
				<td height="85" bordercolorlight="#D98A06" bordercolordark="#D98A06"><b>
                                <font face="Aparajita" color="#808080" size="5"><%=id%>&nbsp;.&nbsp;<%=notice%></font></b></td>
				<td height="85" bordercolorlight="#D98A06" bordercolordark="#D98A06" width="151">
				<p align="center"><b><font face="Arial Narrow" color="#808080">
				<a href="ctrainerreg.jsp"><font color="#808080">Register</font></a></font></b></td>
			</tr>
        <% 
	...
	<div style="position: absolute; width: 158px; height: 46px; z-index: 2; left: 328px; top: 107px" id="layer7">
		<b><font face="Tahoma" size="6" color="#FFFFFF">ITZACK</font></b></div>
	...
	<p><img border="0" src="images/Head.jpg" width="764" height="250"></div>
