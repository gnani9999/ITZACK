...
<html>
 ...
 <div style="border-style:solid; border-color:#FCD99E; position: absolute; width: 760px; height: 564px; z-index: 1; left: 297px; top: 301px" id="layer6">
             <div style="position: absolute; width: 266px; height: 87px; z-index: 1; left: 287px; top: 95px" id="layer1">
                 <table border="0" width="100%" id="table1">
                     ...
                     %>
                     <tr>
                         <td width="135"><b><font face="Verdana" size="2">Institute 
                         :</font></b></td>
             ...
             <div style="position: absolute; width: 190px; height: 50px; z-index: 1; left: 347px; top: 192px" id="layer2">
             ...
             <div style="position: absolute; width: 269px; height: 36px; z-index: 4; left: 311px; top: 24px" id="layer4">
                 <u><b><font face="Poor Richard" size="5" color="#A60000">Search By 
                 Criteria</font></b></u>
             </div>  
             <div style="position: absolute; width: 50px; height: 28px; z-index: 3; left: 611px; top: 71px" id="layer5">
